...
const SEQUENCER_PRESET_1 = {
    ...
    tracks: [
        {
            id: "kick",
            data: [true, false, false, false, true, false, false, false ,true, false, false, false, true, false, false, false]
        },
        {
            id: "snare",
            data: [false, false, true, false, false, false, true, false ,false, false, true, false, false, false, true, false]
        },
        {
            id: "hh",
        ...
        {
            id: "shaker",
            data: [false, false, true, true, false, false, true, true ,false, false, true, true, false, false, true, true]
        }
